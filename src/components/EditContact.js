...
// here is our edit contact function in which above imported hooks are used
const EditContact = () => {
    ...
    // returning jsx for our edit contact page
    return (
        <div className='container'>
            {
                currentContact ? (
                    <>
                        <h1 className='display-3 text-center fw-bold text-primary mt-5 mb-5 text-decoration-underline'>Update Contact {id}</h1>
                        <div className='row'>
...
// exporting edit contact component
